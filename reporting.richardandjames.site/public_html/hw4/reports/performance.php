  ...
  <div class="container">
    <div class="header">
      <div class="title-wrap">
        ...
        <p>Performance-related events collected from the analytics pipeline.</p>
      </div>
      <div class="nav">
    ...
    <div class="card">
      ...
      <p>
        This report summarizes performance event data by page.
        It helps identify which pages produce the most recorded performance activity.
      </p>
    </div>
    ...
    <div class="card">
      ...
      <table>
        <tr><th>Timestamp</th><th>Type</th><th>Session</th><th>Page</th><th>Payload</th></tr>
        <?php foreach ($tableRows as $r): ?>
          <tr>
            ...
            <td><pre><?= htmlspecialchars($r["payload"] ?? "") ?></pre></td>
          </tr>
        <?php endforeach; ?>
      </table>
    </div>
