...
<head>
  ...
  <title>Saved Behavioral Report</title>
  ...
  <div class="container">
    <div class="header">
      <div class="title-wrap">
        <h1>Saved Behavioral Report</h1>
        <p>Viewer-safe report showing event type distribution.</p>
      </div>
      <div class="nav">
    ...
    <div class="card">
      ...
      <p>
        The behavioral report summarizes the most common event categories captured by the analytics system.
        It provides a high-level view of how users interact with the site.
      </p>
    </div>
